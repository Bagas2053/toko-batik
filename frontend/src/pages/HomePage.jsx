...
const KAT_META = [
  { key: 'Kemeja Batik', icon: 'bi-person-bounding-box', desc: 'Cocok untuk kerja & acara formal' },
  { key: 'Dress Batik', icon: 'bi-stars', desc: 'Gaya elegan untuk berbagai kesempatan' },
  { key: 'Kain Batik', icon: 'bi-grid-3x3-gap', desc: 'Kain siap dijahit sesuai selera' },
];

export default function HomePage() {
  const { produk, artikelTampil, loading, error } = useBerandaData();
  const produkTampil = (produk || []).slice(0, 8);
      ...
      <section className="hero-lads">
        <div className="container py-5 py-lg-5">
          <div className="row align-items-center g-4 g-lg-5">
            ...
            <div className="col-lg-6">
              <div className="hero-visual hero-visual--batik">
                {HERO.gambar ? (
                  <img src={HERO.gambar} alt={HERO.gambar_alt} className="hero-img" />
                ) : (
                  <div className="hero-showcase">
                    <div className="hero-showcase__glow" />
                    <img src="/logo-batik-icon.svg" alt="" className="hero-showcase__logo" />
                    <h2 className="hero-showcase__name">Toko Batik Ananda</h2>
                    <p className="hero-showcase__tag">Batik Modern Berjiwa Tradisional</p>
                    <div className="hero-showcase__chips">
